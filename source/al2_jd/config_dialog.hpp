...
namespace apn::dark
{
	...
	inline struct ConfigDialog : my::Dialog, Lockable
	{
		...
		BOOL to_ui()
		{
			...
			set_check(IDC_SLIMBAR_FLAG_WHOLE_TITLE, my::slimbar_t::config.flag_whole_title);
			set_text(IDC_SLIMBAR_TITLE_FORMAT, my::slimbar_t::config.title_format);
			set_int(IDC_SLIMBAR_BUTTON_WIDTH, my::slimbar_t::config.button_width);
...
//			get_text(IDC_JD_STYLE_FILE_NAME, hive.jd.style_file_name);
			...
			get_check(IDC_SLIMBAR_FLAG_WHOLE_TITLE, my::slimbar_t::config.flag_whole_title);
			get_text(IDC_SLIMBAR_TITLE_FORMAT, my::slimbar_t::config.title_format);
			get_int(IDC_SLIMBAR_BUTTON_WIDTH, my::slimbar_t::config.button_width);
			...
			case WM_COMMAND:
				{
					...
					case IDC_SLIMBAR_FLAG_WHOLE_TITLE:
						{
							if (my::slimbar_t::config.flag_use)
							{
								from_ui(FALSE);
